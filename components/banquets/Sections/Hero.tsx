      ...
      <div className={styles.inner}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.content}>
            {/* KICKER */}
            <span className={styles.kicker}>Celebrate Grand Moments at</span>

            <h1 className={styles.title}>PAL HEIGHTS Banquets</h1>

            <div className={styles.subRow}>
              <h2 className={styles.subtitle}>Perfect for weddings,</h2>
              <h2 className={styles.subtitle}>corporate gatherings, and</h2>
